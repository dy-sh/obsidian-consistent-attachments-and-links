 ...
 * @file
 *
 * Shared integration suite for issue #151: the plugin's link-rewriting operations must SKIP files
...
/**
 * Registers the Excalidraw link-skip integration test for the given platform.
 *
 * @param platform - Human-readable platform label used in the test name (e.g. `'desktop'`).
 */
export function registerExcalidrawLinkSkipSuite(platform: string): void {
