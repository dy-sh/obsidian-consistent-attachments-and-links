...
Follow the steps in [03 Check vault consistency](<../../03 Check vault consistency.md>): run **Check Vault Consistency** and watch the drawing appear under **Misplaced attachments** - because `.excalidraw.md` is listed in `treatAsAttachmentExtensions` - while **Shared target**, a note like any other, does not.
